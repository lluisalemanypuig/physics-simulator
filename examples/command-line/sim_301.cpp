...
namespace study_cases {
	...
	void sim_301_usage() {
		...
		cout << "and creates a geometrical object with it. Then takes" << endl;
		cout << "takes the vertices of the object, makes an octree with" << endl;
		cout << "them and uses the sphere passed as parameter to perform" << endl;
		cout << "a range query." << endl;
		cout << endl;
		cout << "Options:" << endl;
		cout << endl;
	...
	void sim_301(int argc, char *argv[]) {
		...
		cout << "Points likely to be within radius:";
		for (size_t idx : idxs) {
			cout << "    " << idx << " ("
