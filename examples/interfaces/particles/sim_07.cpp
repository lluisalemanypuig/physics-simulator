...
namespace study_cases {
	...
	void sim_07_regular_keys_keyboard(unsigned char c, int x, int y) {
	...
	int sim_07_initGL(int argc, char *argv[]) {
		// ----------------- //
		/* initialise window */
		glutInit(&argc, argv);
	...
	void sim_07(int argc, char *argv[]) {
		...
		glutKeyboardFunc(sim_07_regular_keys_keyboard);
