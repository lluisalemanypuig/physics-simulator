...
namespace study_cases {
	...
	void sim_005_help() {
		...
		cout << "Simulation 005 description:" << endl;
		cout << endl;
	...
	void sim_005_regular_keys_keyboard(unsigned char c, int x, int y) {
	...
	void sim_005_initGL(int argc, char *argv[]) {
		// ----------------- //
		/* initialise window */
		glutInit(&argc, argv);
	...
	void sim_005(int argc, char *argv[]) {
		...
		glutKeyboardFunc(sim_005_regular_keys_keyboard);
