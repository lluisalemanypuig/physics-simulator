 ...
 * particles.
 *
 * Although a free particle's behaviour cannot be altered
 * by other particles (like in a spring mesh) it can be
 * so by the force fields generated by other particles.
 * When specified in the simulator, any moving particle
 * may create a variable electric field that acts on
 * the other particles, including a mesh's particles.
 */
class free_particle {
	private:
