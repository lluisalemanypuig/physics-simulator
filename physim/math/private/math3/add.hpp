...
// h <- f + g
#define __pm3_add_v_v(h, f,g)							\
	__pm3_assign_c(h, (f).x + (g).x,					\
					  (f).y + (g).y,					\
					  (f).z + (g).z)
// h <- f + g + (x,y,z)
#define __pm3_add_v_v_c(h, f,g, x,y,z)					\
	__pm3_assign_c(h, (f).x + (g).x + (x),				\
					  (f).y + (g).y + (y),				\
					  (f).z + (g).z + (z))
// h <- f + g + (x,y,z) + (s,s,s)
#define __pm3_add_v_v_c_s(h, f,g, x,y,z, s)				\
	__pm3_assign_c(h, (f).x + (g).x + (x) + (s),		\
					  (f).y + (g).y + (y) + (s),		\
					  (f).z + (g).z + (z) + (s))
// h <- f + g + (s,s,s)
#define __pm3_add_v_v_s(h, f,g,s)						\
	__pm3_assign_c(h, (f).x + (g).x + (s),				\
					  (f).y + (g).y + (s),				\
					  (f).z + (g).z + (s))
// h <- f + (x,y,z)
#define __pm3_add_v_c(h, f, x,y,z)						\
	__pm3_assign_c(h, (f).x + (x),						\
					  (f).y + (y),						\
					  (f).z + (z))
// h <- f + (x,y,z) + (s,s,s)
#define __pm3_add_v_c_s(h, f, x,y,z, s)					\
	__pm3_assign_c(h, (f).x + (x) + (s),				\
					  (f).y + (y) + (s),				\
					  (f).z + (z) + (s))
// g <- f + (s,s,s)
#define __pm3_add_v_s(g, f,s)							\
	__pm3_assign_c(g, (f).x + (s),						\
					  (f).y + (s),						\
					  (f).z + (s))
// h <- (fx,fy,fz) + (gx,gy,gz)
#define __pm3_add_c_c(h, fx,fy,fz, gx,gy,gz)			\
	__pm3_assign_c(h, (fx) + (gx),						\
					  (fy) + (gy),						\
					  (fz) + (gz))
// h <- (fx,fy,fz) + (gx,gy,gz) + (s,s,s)
#define __pm3_add_c_c_s(h, fx,fy,fz, gx,gy,gz, s)		\
	__pm3_assign_c(h, (fx) + (gx) + (s),				\
					  (fy) + (gy) + (s),				\
					  (fz) + (gz) + (s))
// h <- f + g*(x,y,z)
#define __pm3_add_v_vc(h, f, g,x,y,z)					\
	__pm3_assign_c(h, (f).x + (g).x*(x),				\
					  (f).y + (g).y*(y),				\
					  (f).z + (g).z*(z))
// h <- f + g*s
#define __pm3_add_v_vs(h, f, g,s)						\
	__pm3_assign_c(h, (f).x + (g).x*(s),				\
					  (f).y + (g).y*(s),				\
					  (f).z + (g).z*(s))
// i <- f + g*s + h
#define __pm3_add_v_vs_v(i, f, g,s, h)					\
	__pm3_assign_c(i, (f).x + (g).x*(s) + (h).x,		\
					  (f).y + (g).y*(s) + (h).y,		\
					  (f).z + (g).z*(s) + (h).z)
// h <- f + g*s + (x,y,z)
#define __pm3_add_v_vs_c(h, f, g,s, x,y,z)				\
	__pm3_assign_c(h, (f).x + (g).x*(s) + x,			\
					  (f).y + (g).y*(s) + y,			\
					  (f).z + (g).z*(s) + z)
// h <- f + g*s1 + (s2,s2,s2)
#define __pm3_add_v_vs_s(h, f, g,s1, s2)				\
	__pm3_assign_c(h, (f).x + (g).x*(s1) + (s2),		\
					  (f).y + (g).y*(s1) + (s2),		\
					  (f).z + (g).z*(s1) + (s2))
// h <- f*s1 + g*s2
#define __pm3_add_vs_vs(h, f,s1, g,s2)					\
	__pm3_assign_c(h, (f).x*(s1) + (g).x*(s2),			\
					  (f).y*(s1) + (g).y*(s2),			\
					  (f).z*(s1) + (g).z*(s2))
// i <- f*s1 + g*s2 + h
#define __pm3_add_vs_vs_v(i, f,s1, g,s2, h)				\
	__pm3_assign_c(i, (f).x*(s1) + (g).x*(s2) + (h).x,	\
					  (f).y*(s1) + (g).y*(s2) + (h).y,	\
					  (f).z*(s1) + (g).z*(s2) + (h).z)
// h <- f*s1 + g*s2 + (x,y,z)
#define __pm3_add_vs_vs_c(h, f,s1, g,s2, x,y,z)			\
	__pm3_assign_c(h, (f).x*(s1) + (g).x*(s2) + (x),	\
					  (f).y*(s1) + (g).y*(s2) + (y),	\
					  (f).z*(s1) + (g).z*(s2) + (z))
// h <- f*s1 + g*s2 + (s3,s3,s3)
#define __pm3_add_vs_vs_s(h, f,s1, g,s2, s3)			\
